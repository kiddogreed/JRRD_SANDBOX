...
/**
 * Lesson 2: Game Loop and Custom Rendering
 * 
 * This introduces the fundamental game loop concept:
 * 1. Update game state
 * 2. Render/Draw everything
 * 3. Repeat
 * 
 * This is the foundation of ALL games!
 */
public class GameLoop extends JPanel implements Runnable, KeyListener {
    ...
    private static final long TARGET_TIME = 1000000000 / TARGET_FPS; // nanoseconds
    ...
    private int rectVelX = 2;
    private int rectVelY = 2;
    private Color rectColor = Color.CYAN;
    ...
    public void run() {
        ...
        while (running) {
            ...
            if (waitTime > 0) {
                try {
                    Thread.sleep(waitTime / 1000000); // convert to milliseconds
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
