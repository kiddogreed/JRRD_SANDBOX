...
/**
 * Lesson 9: Background Layers with Parallax Scrolling
 * 
 * This builds on the DayNightGame and adds:
 * 1. Multi-layered parallax backgrounds for depth
 * 2. Dynamic mountains, hills, and distant terrain
 * 3. Time-based color tinting for background layers
 * 4. Smooth scrolling at different speeds
 * 5. Enhanced atmospheric depth
 * 
 * All previous features from lessons 1-8 are included:
 * - Complete inventory and health systems
...
class TimeSystem {
    ...
    public Color getSkyColor() {
        ...
        if (timeOfDay >= 0.0f && timeOfDay < 0.3f) {
            // Night to dawn (dark blue to orange) - extended night period
            float t = timeOfDay / 0.3f;
            return interpolateColor(new Color(15, 15, 35), new Color(255, 100, 50), t);
            ...
            // Dusk to night (orange to dark blue) - extended night period
            float t = (timeOfDay - 0.7f) / 0.3f;
            return interpolateColor(new Color(255, 100, 50), new Color(15, 15, 35), t);
        }
    }
    ...
    public float getAmbientLight() {
        ...
        if (timeOfDay >= 0.35f && timeOfDay < 0.65f) {
            ...
            return 0.1f; // Night (minimum light for visibility) - longer night period
        }
    }
