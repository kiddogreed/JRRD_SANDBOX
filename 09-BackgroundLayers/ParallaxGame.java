...
public class ParallaxGame extends JPanel implements Runnable, KeyListener, MouseListener {
    ...
    public ParallaxGame() {
        ...
        System.out.println("Parallax Background System initialized!");
        System.out.println("Controls: A/D - Move, Space - Jump, 1-9 - Select slot");
        System.out.println("Features: Multi-layered parallax backgrounds with depth!");
        System.out.println("Watch the background layers move at different speeds as you explore!");
    }
    ...
    private void drawUI(Graphics2D g2d) {
        g2d.setColor(Color.WHITE);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString("Parallax Backgrounds Demo - Lesson 9", 10, 20);
        ...
        g2d.drawString("Watch the background layers scroll!", 10, 95);
    }
    ...
    public static void main(String[] args) {
        ...
        ParallaxGame game = new ParallaxGame();
