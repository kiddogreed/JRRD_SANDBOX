...
/**
 * Lesson 10: Simple Lighting Effects
 * 
 * This builds on all previous lessons and adds:
 * 1. LAMP tile type with warm glowing light
 * 2. Enhanced light rendering with gradient glow
 * 3. Simple shadow effects from solid blocks
 * 4. Better visibility during night with lamps
 * 
 * New features:
 * - LAMP block that emits strong warm light (better than torches)
 * - Soft glow effect around lamps
 * - Shadow darkening for blocks that block light
 * - Improved atmosphere for caves and night exploration
 * 
 * All previous features from lessons 1-9 are included.
 */
